...
public final class SundayDAO_Impl implements SundayDAO {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<DietPlanDataSunday> __insertionAdapterOfDietPlanDataSunday;

  private final EntityDeletionOrUpdateAdapter<DietPlanDataSunday> __deletionAdapterOfDietPlanDataSunday;
  ...
  public SundayDAO_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfDietPlanDataSunday = new EntityInsertionAdapter<DietPlanDataSunday>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `dietplan_sunday` (`ID`,`breakfastName`,`breakfastCalories`,`brunchName`,`brunchCalories`,`lunchName`,`lunchCalories`,`teaName`,`teaCalories`,`dinnerName`,`dinnerCalories`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, DietPlanDataSunday value) {
    ...
    this.__deletionAdapterOfDietPlanDataSunday = new EntityDeletionOrUpdateAdapter<DietPlanDataSunday>(__db) {
      @Override
      public String createQuery() {
        return "DELETE FROM `dietplan_sunday` WHERE `ID` = ?";
      }
    ...
    this.__preparedStmtOfUpdateAll = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET breakfastName = ?,breakfastCalories = ?,brunchName = ?,brunchCalories = ?,lunchName = ?,lunchCalories = ?,teaName = ?,teaCalories = ?,dinnerName = ?,dinnerCalories=?,createdAt =? WHERE ID = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET breakfastName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET breakfastCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET brunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET brunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET lunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET lunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET teaName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET teaCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET dinnerName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_sunday SET dinnerCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insert(final DietPlanDataSunday dietplansunday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfDietPlanDataSunday.insert(dietplansunday);
  ...
  @Override
  public void delete(final DietPlanDataSunday dietplansunday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataSunday.handle(dietplansunday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void reset(final List<DietPlanDataSunday> dietPlanDatumsunday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataSunday.handleMultiple(dietPlanDatumsunday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public List<DietPlanDataSunday> getAll() {
    final String _sql = "SELECT * FROM dietplan_sunday";
    ...
    try {
      ...
      final List<DietPlanDataSunday> _result = new ArrayList<DietPlanDataSunday>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final DietPlanDataSunday _item;
        _item = new DietPlanDataSunday();
        final int _tmpID;
  ...
  public String breakfastNameFinder(final String sDate) {
    final String _sql = "SELECT breakfastName FROM dietplan_sunday WHERE createdAt = ?";
  ...
  public String breakfastCaloriesFinder(final String sDate) {
    final String _sql = "SELECT breakfastCalories FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchNameFinder(final String sDate) {
    final String _sql = "SELECT brunchName FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT brunchCalories FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchNameFinder(final String sDate) {
    final String _sql = "SELECT lunchName FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT lunchCalories FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaNameFinder(final String sDate) {
    final String _sql = "SELECT teaName FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaCaloriesFinder(final String sDate) {
    final String _sql = "SELECT teaCalories FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerNameFinder(final String sDate) {
    final String _sql = "SELECT dinnerName FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerCaloriesFinder(final String sDate) {
    final String _sql = "SELECT dinnerCalories FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public boolean checkIfGivenDataEntryExists(final String currentDate) {
    final String _sql = "SELECT createdAt FROM dietplan_sunday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (currentDate == null) {
      _statement.bindNull(_argIndex);
