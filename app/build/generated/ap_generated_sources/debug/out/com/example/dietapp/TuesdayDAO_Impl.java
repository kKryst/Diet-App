...
public final class TuesdayDAO_Impl implements TuesdayDAO {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<DietPlanDataTuesday> __insertionAdapterOfDietPlanDataTuesday;

  private final EntityDeletionOrUpdateAdapter<DietPlanDataTuesday> __deletionAdapterOfDietPlanDataTuesday;
  ...
  public TuesdayDAO_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfDietPlanDataTuesday = new EntityInsertionAdapter<DietPlanDataTuesday>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `dietplan_tuesday` (`ID`,`breakfastName`,`breakfastCalories`,`brunchName`,`brunchCalories`,`lunchName`,`lunchCalories`,`teaName`,`teaCalories`,`dinnerName`,`dinnerCalories`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, DietPlanDataTuesday value) {
    ...
    this.__deletionAdapterOfDietPlanDataTuesday = new EntityDeletionOrUpdateAdapter<DietPlanDataTuesday>(__db) {
      @Override
      public String createQuery() {
        return "DELETE FROM `dietplan_tuesday` WHERE `ID` = ?";
      }
    ...
    this.__preparedStmtOfUpdateAll = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET breakfastName = ?,breakfastCalories = ?,brunchName = ?,brunchCalories = ?,lunchName = ?,lunchCalories = ?,teaName = ?,teaCalories = ?,dinnerName = ?,dinnerCalories=?,createdAt =? WHERE ID = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET breakfastName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET breakfastCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET brunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET brunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET lunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET lunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET teaName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET teaCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET dinnerName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_tuesday SET dinnerCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insert(final DietPlanDataTuesday dietplantuesday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfDietPlanDataTuesday.insert(dietplantuesday);
  ...
  @Override
  public void delete(final DietPlanDataTuesday dietplantuesday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataTuesday.handle(dietplantuesday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void reset(final List<DietPlanDataTuesday> dietPlanDatumTuesday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataTuesday.handleMultiple(dietPlanDatumTuesday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  public List<DietPlanDataWednesday> getAll() {
    final String _sql = "SELECT * FROM dietplan_tuesday";
  ...
  public String breakfastNameFinder(final String sDate) {
    final String _sql = "SELECT breakfastName FROM dietplan_tuesday WHERE createdAt = ?";
  ...
  public String breakfastCaloriesFinder(final String sDate) {
    final String _sql = "SELECT breakfastCalories FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchNameFinder(final String sDate) {
    final String _sql = "SELECT brunchName FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT brunchCalories FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchNameFinder(final String sDate) {
    final String _sql = "SELECT lunchName FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT lunchCalories FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaNameFinder(final String sDate) {
    final String _sql = "SELECT teaName FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaCaloriesFinder(final String sDate) {
    final String _sql = "SELECT teaCalories FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerNameFinder(final String sDate) {
    final String _sql = "SELECT dinnerName FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerCaloriesFinder(final String sDate) {
    final String _sql = "SELECT dinnerCalories FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public boolean checkIfGivenDataEntryExists(final String currentDate) {
    final String _sql = "SELECT createdAt FROM dietplan_tuesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (currentDate == null) {
      _statement.bindNull(_argIndex);
