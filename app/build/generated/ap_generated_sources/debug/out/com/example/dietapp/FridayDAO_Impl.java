...
public final class FridayDAO_Impl implements FridayDAO {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<DietPlanDataFriday> __insertionAdapterOfDietPlanDataFriday;

  private final EntityDeletionOrUpdateAdapter<DietPlanDataFriday> __deletionAdapterOfDietPlanDataFriday;
  ...
  public FridayDAO_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfDietPlanDataFriday = new EntityInsertionAdapter<DietPlanDataFriday>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `dietplan_friday` (`ID`,`breakfastName`,`breakfastCalories`,`brunchName`,`brunchCalories`,`lunchName`,`lunchCalories`,`teaName`,`teaCalories`,`dinnerName`,`dinnerCalories`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, DietPlanDataFriday value) {
    ...
    this.__deletionAdapterOfDietPlanDataFriday = new EntityDeletionOrUpdateAdapter<DietPlanDataFriday>(__db) {
      @Override
      public String createQuery() {
        return "DELETE FROM `dietplan_friday` WHERE `ID` = ?";
      }
    ...
    this.__preparedStmtOfUpdateAll = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET breakfastName = ?,breakfastCalories = ?,brunchName = ?,brunchCalories = ?,lunchName = ?,lunchCalories = ?,teaName = ?,teaCalories = ?,dinnerName = ?,dinnerCalories=?,createdAt =? WHERE ID = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET breakfastName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET breakfastCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET brunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET brunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET lunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET lunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET teaName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET teaCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET dinnerName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_friday SET dinnerCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insert(final DietPlanDataFriday dietplanfriday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfDietPlanDataFriday.insert(dietplanfriday);
  ...
  @Override
  public void delete(final DietPlanDataFriday dietplanfriday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataFriday.handle(dietplanfriday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void reset(final List<DietPlanDataFriday> dietPlanDatumfriday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataFriday.handleMultiple(dietPlanDatumfriday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public List<DietPlanDataFriday> getAll() {
    final String _sql = "SELECT * FROM dietplan_friday";
    ...
    try {
      ...
      final List<DietPlanDataFriday> _result = new ArrayList<DietPlanDataFriday>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final DietPlanDataFriday _item;
        _item = new DietPlanDataFriday();
        final int _tmpID;
  ...
  public String breakfastNameFinder(final String sDate) {
    final String _sql = "SELECT breakfastName FROM dietplan_friday WHERE createdAt = ?";
  ...
  public String breakfastCaloriesFinder(final String sDate) {
    final String _sql = "SELECT breakfastCalories FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchNameFinder(final String sDate) {
    final String _sql = "SELECT brunchName FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT brunchCalories FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchNameFinder(final String sDate) {
    final String _sql = "SELECT lunchName FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT lunchCalories FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaNameFinder(final String sDate) {
    final String _sql = "SELECT teaName FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaCaloriesFinder(final String sDate) {
    final String _sql = "SELECT teaCalories FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerNameFinder(final String sDate) {
    final String _sql = "SELECT dinnerName FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerCaloriesFinder(final String sDate) {
    final String _sql = "SELECT dinnerCalories FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public boolean checkIfGivenDataEntryExists(final String currentDate) {
    final String _sql = "SELECT createdAt FROM dietplan_friday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (currentDate == null) {
      _statement.bindNull(_argIndex);
