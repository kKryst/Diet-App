...
public final class WednesdayDAO_Impl implements WednesdayDAO {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<DietPlanDataWednesday> __insertionAdapterOfDietPlanDataWednesday;

  private final EntityDeletionOrUpdateAdapter<DietPlanDataWednesday> __deletionAdapterOfDietPlanDataWednesday;
  ...
  public WednesdayDAO_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfDietPlanDataWednesday = new EntityInsertionAdapter<DietPlanDataWednesday>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `dietplan_wednesday` (`ID`,`breakfastName`,`breakfastCalories`,`brunchName`,`brunchCalories`,`lunchName`,`lunchCalories`,`teaName`,`teaCalories`,`dinnerName`,`dinnerCalories`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, DietPlanDataWednesday value) {
    ...
    this.__deletionAdapterOfDietPlanDataWednesday = new EntityDeletionOrUpdateAdapter<DietPlanDataWednesday>(__db) {
      @Override
      public String createQuery() {
        return "DELETE FROM `dietplan_wednesday` WHERE `ID` = ?";
      }
    ...
    this.__preparedStmtOfUpdateAll = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET breakfastName = ?,breakfastCalories = ?,brunchName = ?,brunchCalories = ?,lunchName = ?,lunchCalories = ?,teaName = ?,teaCalories = ?,dinnerName = ?,dinnerCalories=?,createdAt =? WHERE ID = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET breakfastName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBreakfastCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET breakfastCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET brunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateBrunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET brunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET lunchName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateLunchCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET lunchCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET teaName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateTeaCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET teaCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerName = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET dinnerName = ? WHERE createdAt = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateDinnerCalories = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE dietplan_wednesday SET dinnerCalories = ? WHERE createdAt = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insert(final DietPlanDataWednesday dietplantuesday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfDietPlanDataWednesday.insert(dietplantuesday);
  ...
  @Override
  public void delete(final DietPlanDataWednesday dietplantuesday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataWednesday.handle(dietplantuesday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void reset(final List<DietPlanDataWednesday> dietPlanDatumTuesday) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfDietPlanDataWednesday.handleMultiple(dietPlanDatumTuesday);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public List<DietPlanDataWednesday> getAll() {
    final String _sql = "SELECT * FROM dietplan_wednesday";
    ...
    try {
      ...
      final List<DietPlanDataWednesday> _result = new ArrayList<DietPlanDataWednesday>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final DietPlanDataWednesday _item;
        _item = new DietPlanDataWednesday();
        final int _tmpID;
  ...
  public String breakfastNameFinder(final String sDate) {
    final String _sql = "SELECT breakfastName FROM dietplan_wednesday WHERE createdAt = ?";
  ...
  public String breakfastCaloriesFinder(final String sDate) {
    final String _sql = "SELECT breakfastCalories FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchNameFinder(final String sDate) {
    final String _sql = "SELECT brunchName FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String brunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT brunchCalories FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchNameFinder(final String sDate) {
    final String _sql = "SELECT lunchName FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String lunchCaloriesFinder(final String sDate) {
    final String _sql = "SELECT lunchCalories FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaNameFinder(final String sDate) {
    final String _sql = "SELECT teaName FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String teaCaloriesFinder(final String sDate) {
    final String _sql = "SELECT teaCalories FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerNameFinder(final String sDate) {
    final String _sql = "SELECT dinnerName FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public String dinnerCaloriesFinder(final String sDate) {
    final String _sql = "SELECT dinnerCalories FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (sDate == null) {
      _statement.bindNull(_argIndex);
  ...
  public boolean checkIfGivenDataEntryExists(final String currentDate) {
    final String _sql = "SELECT createdAt FROM dietplan_wednesday WHERE createdAt = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (currentDate == null) {
      _statement.bindNull(_argIndex);
